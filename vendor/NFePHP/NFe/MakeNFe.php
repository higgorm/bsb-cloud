...
class MakeNFe extends BaseMake
{
    ...
    // Arrays
    private $aTotICMSUFDest = array('vFCPUFDest' => 0.00, 'vICMSUFDest' => 0.00, 'vICMSUFRemet' => 0.00);
    ...
    public function tagICMSTot(
        ...
        $this->dom->addChild($ICMSTot, "vFCPUFDest", $this->aTotICMSUFDest['vFCPUFDest'], true, "Valor total do ICMS relativo ao Fundo de Combate à Pobreza(FCP) para a UF de destino");
        $this->dom->addChild($ICMSTot, "vICMSUFDest", $this->aTotICMSUFDest['vICMSUFDest'], true, "Valor total do ICMS de partilha para a UF do destinatário");
        ...
        $this->dom->addChild($ICMSTot, "vFCP", 0.00, true, "Valor Fundo Combate a Pobreza");
        ...
        $this->dom->addChild($ICMSTot, "vFCPST", 0.00, true, "Valor 4.00");
        $this->dom->addChild($ICMSTot, "vFCPSTRet", 0.00, true, "Valor 4.00");
        ...
        $this->dom->addChild($ICMSTot, "vIPIDevol", 0.00, true, "Valor do IPI Devolução");
    ...
    public function tagpag(
        ...
        $this->dom->addChild($detPag, "tPag", $tPag, true, "Forma de pagamento");
        $this->dom->addChild($detPag, "vPag", $vPag, true, "Valor do Pagamento");
        $this->dom->appChild($this->aPag[$num-1], $detPag, "DetPag");
        return $pag;
    }
