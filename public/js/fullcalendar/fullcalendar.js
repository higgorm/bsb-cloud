    ...
    function ResourceView(element, calendar, viewName) {
        ...
        function buildSkeleton(maxRowCnt, showNumbers) {
            ...
            for (i = 0; i < maxRowCnt; i++) {
                ...
                s += "<tr class='fc-resourcerow-" + id + "'><td class='fc-resourceName'>" + resourceName + "</td>";
                for (j = 0; j < colCnt; j++) {
                    s += "<td class='fc- " + contentClass + " fc-day" + j + " fc-resource" + id + "'>" + // need fc- for setDayID
                            "<div>" +
                            (showNumbers ?
        ...
        function updateCells(firstTime) {
            ...
            headCells.each(function(i, _cell) {
                ...
                if (date.getDay() == 1 && viewName == "resourceNextWeeks")
                    cell.html(cell.html() + '<br>' + opt('weekPrefix') + ' ' + iso8601Week(date));
            ...
            bodyCells.each(function(i, _cell) {
                ...
                if (date.getDay() == 0 || date.getDay() == 6)
                    cell.addClass('fc-weekend-column');
                                ...
                                if (!opt('weekends') && (dayDelta > 0 || dayDelta < 0)) {
                                    if (dayDelta > 0) {
                                        for (i = 1; i <= dayDeltaStart; i++) {
                                            ...
                                            if (weekendTestDate.getDay() == 6 || weekendTestDate.getDay() == 0)
                                                dayDeltaStart++;
                                        }
                    ...
                    if (viewName == 'resourceDay' && (minuteDelta || resourceDelta)) {
                        ...
                        if (!opt('weekends')) {
                            ...
                            if (dayDelta > 0) {
                                ...
                                if (daysToAdd > 0)
                                    event.start = addDays(cloneDate(event.start), daysToAdd, true);
                                ...
                                if (daysToAdd > 0)
                                    event.end = addDays(cloneDate(event.end), daysToAdd, true);
                            }
                            else {
                                daysToDel = 0;
                                ...
                                if (daysToDel < 0)
                                    event.start = addDays(cloneDate(event.start), daysToDel, true);
                                ...
                                if (daysToDel < 0)
                                    event.end = addDays(cloneDate(event.end), daysToDel, true);
                            }
                        }
                    ...
                    if (dayDelta) {
                        if (!opt('weekends')) {
                            ...
                            if (dayDelta > 0) {
                                ...
                                if (daysToAdd > 0)
                                    event.end = addDays(cloneDate(visEnd), daysToAdd, true);
                            }
                            else {
                                var daysToDel = 0;
                                for (i = -1; i >= dayDelta + daysToDel; i--) {
                                ...
                                if (daysToDel < 0)
                                    event.end = addDays(cloneDate(visEnd), daysToDel, true);
                            }
                        }
