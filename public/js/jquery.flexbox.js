...
(function($) {
    $.flexbox = function(div, o) {
                    ...
                    var callback = function(data, overrideQuery) {
                        ...
                        if (isNaN(totalResults) && o.paging) {
                            if (o.maxCacheBytes <= 0)
                                alert('The "maxCacheBytes" configuration option must be greater\nthan zero when implementing client-side paging.');
        ...
        function displayItems(d, q) {
            ...
            for (var i = 0; i < d[o.resultsProperty].length; i++) {
                ...
                $row = $('<div></div>')
                        ...
                        .attr('cdcliente', data[o.cdcliente])//LINHA ADICIONADA 
                        .attr('fone1', data[o.fone1])//LINHA ADICIONADA 
                        .attr('fone2', data[o.fone2])//LINHA ADICIONADA 
                        .attr('cnpj' , data[o.cnpj])//LINHA ADICIONADA 
                        .addClass('row')
                        .html(result)
                        .appendTo($content);
        ...
        function selectCurr() {
            ...
            if ($curr) {
                ...
                //LINHAS ADICIONADAS - INICIO
                $("input[name='cd_cliente']").val($curr.attr('cdcliente'));
                $('#ds_fone1').val($curr.attr('fone1'));
                $('#ds_fone2').val($curr.attr('fone2'));
                $("#destCNPJ").val($curr.attr('cnpj'));
				$("#codCliente").val($curr.attr('cdcliente'));
    ...
    $.fn.flexbox.defaults = {
        ...
        cdcliente:'cdcliente',//LINHAS ADICIONADAS
        fone1:'fone1',//LINHAS ADICIONADAS 
        fone2:'fone2',//LINHAS ADICIONADAS
        cnpj:'cnpj'//LINHAS ADICIONADAS
    };
