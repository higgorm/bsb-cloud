...
tinymce.PluginManager.add("responsivefilemanager", function(e) {
    function t() {
        ...
        if (typeof e.settings.filemanager_title !== "undefined" && e.settings.filemanager_title) {
            t = e.settings.filemanager_title
        }
        var n = "key";
        ...
        var o = 2;
        if (typeof e.settings.filemanager_type !== "undefined" && e.settings.filemanager_type) {
            if ($.isNumeric(e.settings.filemanager_type) === true && e.settings.filemanager_type > 0 && e.settings.filemanager_type <= 3) {
                o = e.settings.filemanager_type
            } else if (e.settings.filemanager_type == "image") {
                o = 1
            } else if (e.settings.filemanager_type == "media") {
                o = 3
            } else {
                o = 2
            }
        }
        win = e.windowManager.open({title: t, file: e.settings.external_filemanager_path + "dialog.php?type=4&descending=" + i + r + s + "&lang=" + e.settings.language + "&akey=" + n, width: 860, height: 570, inline: 1, resizable: true, maximizable: true})
    }
